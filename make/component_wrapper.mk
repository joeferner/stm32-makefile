...
# ie put literal $(STM32_MAKEFILE_PATH), $(PROJECT_PATH) and $(BUILD_DIR_BASE) into the generated
...
$(subst $(STM32_MAKEFILE_PATH),$$(STM32_MAKEFILE_PATH),$(subst $(PROJECT_PATH),$$(PROJECT_PATH),$(subst $(BUILD_DIR_BASE),$$(BUILD_DIR_BASE),$(1))))
endef
...
OBJCOPY_EMBED_ARGS := --input-target binary --rename-section .data=.rodata.embedded
